...
##                maxLiftGain = self.maxLiftGain[idx]
                ...
                shifted_root_polar = rootPolar.get_shiftedPolar(maxGlideShift, self)

                # also update values like maxSpeed, maxGlide etc.
                shifted_root_polar.analyze(self)
...
class polarData:
    ...
    def get_shiftedPolar(self, shiftValue, params):
       ...
       # check whether to shift the polar
        ...
        for i in range(num):
            ...
            #CD_old = shiftedPolar.CD[i]#FIXME
            #shiftedPolar.CD[i] = shiftedPolar.CL[i] / shiftedPolar.CL_CD[i]#FIXME
    ...
    # all CL_CD-values will be scaled by the given scale-factor.
...
def create_new_inputFile(params, i):
    ...
    newFile.init_TargetValues(params, strakPolar)
...
def update_shiftedPolars(params):
    # Before updating, all data must be cleared
    params.shifted_rootPolars.clear()
